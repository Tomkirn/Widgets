...
label1 = ui.Label(font=vfont, text=time_to_holiday(2020,9,28)[1]+'Carolinensiel: '+time_to_holiday(2020,9,28)[0])
#label2 = ui.Label(font=vfont, text='eIP: '+get_global_ip())
label2 = ui.Label(font=vfont, text=time_to_holiday(2020,11,23)[1]+'Keksbackwoche: '+time_to_holiday(2020,11,23)[0])
...
label4.frame = (view.width-50,65,50,35)
